...
def loadModels():
    ...
    xgbModel.load_model(ARTIFACTS / "XGBoost_EUR_USD_H4_2026_v9")
    ...
    nnModel.load_state_dict(torch.load(ARTIFACTS / "NN_EUR_USD_H4_2026_v5.1", map_location=DEVICE))
    nnModel.eval()
    scaler = joblib.load(ARTIFACTS / "scaler_v5.1")
